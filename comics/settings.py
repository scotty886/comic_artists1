...
ALLOWED_HOSTS = [ "dominion13.com", "https://dominion13.com" ,"comicartists1-production.up.railway.app", "https://comicartists1-production.up.railway.app"]
# settings.py
...
# Password validation
# https://docs.djangoproject.com/en/5.1/ref/srettings/#auth-password-validators
